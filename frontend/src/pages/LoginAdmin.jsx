...
function LoginAdmin() {
  ...
  function submit(e) {
    ...
    fetch("http://localhost:8080/api/v1/user/admin-login", requestOptions)
          ...
          <form action="" className="mt-4">
            <div className="flex flex-col mt-4">
              ...
              <input
                ...
                className="shadow p-2 rounded-xl focus:border-blue-400 outline-none mt-1 border bg-gray-50"
              />
            </div>
            <div className="flex flex-col mt-4">
